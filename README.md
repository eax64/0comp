# 0comp
This program let you compress file without loss with a infinite compression rate.
...
1.0M  original
$> ./0comp.py -c original 
The compressed file has been saved in the file: b'AEJaaDkxQVkmU1k4VxzlAAgIQADABAAIIAAwzAUppggGxCAeLuSKcKEgcK45yg=='
